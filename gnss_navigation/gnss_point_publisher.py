...
from geometry_msgs.msg import PointStamped, Point, PointStamped
...
class GPSPointPublisher(Node):
    def __init__(self):
        ...
        self.publisher_ = self.create_publisher(PointStamped, 'gnss_point', 10)
        self.timer = self.create_timer(0.025, self.publish_path)
    ...
    def publish_path(self):
        ...
        self.PointStamped.header.frame_id = "map"
        self.Point.x = x - self.base_x
        self.Point.y = y - self.base_y
        self.PointStamped.point = self.Point
        self.publisher_.publish(self.PointStamped)
